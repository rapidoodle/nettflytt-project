    ...
    <div class="card-body">
        <table id="reportTable" class="display table" style="width:100%">
            ...
            <tbody>
                ...
                <?php
                    $type =$data->type == 1 ? "Topp 5 garanti" : ($data->type == 2 ? "Strøm til lavpris" : ($data->type == 3 ? "Strøm til Lavpris (Kampanje)" : ( $data->type == 4 ? "Sesongpris" : ($data->type == 5 ? "Sesongpris (Kampanje)" : "N/A"))));
                ?>
                    <tr>
                        <td>{{$data->name}}</td>
                        <td>{{$data->email}}</td>
